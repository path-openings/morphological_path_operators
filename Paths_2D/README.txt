...
The code is copyrighted Ben Appleton and Hugues Talbot 2004-2013 and released
...
As a courtesy, we politely request that if you find this code useful in any way,
...
however no legal obligation for you to do this.

The code is not encumbered by patents as far as we know, but we make no
guarantee, expressed or implied, as to the suitability of this code to
your applications.
...
MacOS/X 10.6.8 or later and Linux RHEL/Centos 5.x-6.x, Ubuntu 10.04 or later
using the Unix traditional development tools . We have not tested it under
Windows but it should work. It requires the ImageMagick library for I/O.
...
hugues.talbot@gmail.com or 
hugues.talbot@esiee.fr or 
